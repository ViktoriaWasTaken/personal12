...
while True:
    if progress == 1:
        ...
        print(Fore.GREEN + "You hear a chute open, you fall and hit the ground. Everything goes dark...")
        print("...")
        print("...")
        print("...")
        ...
        print(choice1_1)
        print("As you approach the end of the woodland path, you find a large tree with a strange symbol engraved on a door built into the front of the tree. It's surrounded by a circle pathway dug into the dirt")
